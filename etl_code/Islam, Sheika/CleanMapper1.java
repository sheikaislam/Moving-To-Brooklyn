...
public class CleanMapper1 //mapper (update inputs)
 ...
 throws IOException, InterruptedException {
     ...
     String data = tokens[3] + "\t" + tokens[10] + "\t" + tokens[11];  //boro, zipcode, longitude, latitude, #ofpeople injured, #of people killed
