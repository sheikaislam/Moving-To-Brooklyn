...
public class Clean { //runs MapReduce job, application to find the maximum temperature in the weather dataset
 ...
 job.setJarByClass(Clean.class); //we dont need to explicitly specify the name of the jar file, we can just pass a class in this method. Hadoop will use it to locate the relevant JAR file by looking for the JAR file containing this class.
 ...
 job.setMapperClass(CleanMapper.class); //specify map type
 job.setReducerClass(CleanReducer.class); //specify reduce type
